    ...
    <section class="bg-white">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900">Flexible Ticket Pricing</h2>
                <p class=" font-light text-gray-500 sm:text-xl">Choose the perfect plan for your event, from small
                    gatherings to large festivals.</p>
            </div>
            <div class="w-full flex items-center justify-center my-4">
                <router-link to="/events_create"
                    class="text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Test Create Events
                </router-link>
            </div>
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div
                    ...
                    <p class="font-light text-gray-500 sm:text-lg">Perfect for large events with complex ticketing needs.
                    </p>
                    <div class="flex items-baseline justify-center my-8">
